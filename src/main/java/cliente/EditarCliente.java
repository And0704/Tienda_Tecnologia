...
public class EditarCliente extends javax.swing.JFrame {
    ...
    public EditarCliente(Dashboard dashboard) {
        initComponents();
    ...
    private void initComponents() {
        ...
        IngresoEmail.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                IngresoEmailKeyTyped(evt);
            }
        });
    ...
    private void IngresoEmailKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_IngresoEmailKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_IngresoEmailKeyTyped
    ...
    public void editarCliente(ControladorClientes nuevoCliente) {
        OkHttpClient client = new OkHttpClient();
        Gson gson = new Gson();
        String enlace = "http://192.168.137.1:3000/clientes/" + nuevoCliente.getId_cliente();
