...
public class EditarProducto extends javax.swing.JFrame {
    ...
    ControladorProductos consulta = null;
    ...
    public EditarProducto(Dashboard dashboard) {
        initComponents();
    ...
    public void setID(String idProducto) {
        ...
        ControladorListProductos producto = consultaUNO(idProducto);

        consulta = new ControladorProductos();
        consulta.setId_producto(producto.getId_producto());
        consulta.setNombre(producto.getNombre());
        consulta.setPrecio(producto.getPrecio());
        consulta.setDescripcion(producto.getDescripcion());
        consulta.setStock(producto.getStock());

        IngresoNombre.setText(consulta.getNombre());
        IngresoPrecio.setText(consulta.getPrecio());
        IngresoStock.setText(consulta.getStock());
        IngresoDescripcion.setText(consulta.getDescripcion());
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (IngresoNombre.getText().isEmpty() || IngresoPrecio.getText().isEmpty()
                || IngresoStock.getText().isEmpty() || IngresoDescripcion.getText().isEmpty()) {

            // Mostrar un mensaje de advertencia si alguno de los campos está vacío
            JOptionPane.showMessageDialog(this, "Por favor, complete todos los campos.",
                    "Error", JOptionPane.WARNING_MESSAGE);
        } else {
            // Si todos los campos tienen contenido, editar el objeto y continuar con la lógica
            consulta.setNombre(IngresoNombre.getText());
            consulta.setPrecio(IngresoPrecio.getText());
            consulta.setStock(IngresoStock.getText());
            consulta.setDescripcion(IngresoDescripcion.getText());

            // Llamar al método para editar el producto
            editarProducto(consulta);

            // Activar el dashboard y cerrar la ventana actual
            dashboard.setEnabled(true);
            this.dispose();
        }
    ...
    public void mostrarTodo(List<ControladorListProductos> productos) {
